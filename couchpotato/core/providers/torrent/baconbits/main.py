...
class BaconBits(TorrentProvider):

    urls = {
        'test': 'https://www.baconbits.org/',
        'login' : 'https://www.baconbits.org/login.php',
        'detail': 'https://www.baconbits.org/details?id=%s',
        'search': 'https://www.baconbits.org/browse?method=2&c%d=%d',
        'download': 'https://www.baconbits.org/%s',
    }
